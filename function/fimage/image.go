...
func AdjustContrast(percentage float64) flow.Func {
	return func(in flow.Data) (flow.Data, error) {
		...
		if len(ims) != 0 {
			...
			return nil, AdjustContrastError
		}
	}
}
...
func AdjustBrightness(percentage float64) flow.Func {
	return func(in flow.Data) (flow.Data, error) {
		...
		if len(ims) != 0 {
			...
			return nil, AdjustBrightnessError
		}
	}
}
...
func AdjustSaturation(percentage float64) flow.Func {
	return func(in flow.Data) (flow.Data, error) {
		...
		if len(ims) != 0 {
			...
			return nil, AdjustSaturationError
		}
	}
}
